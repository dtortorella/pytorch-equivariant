...
def equivariant_1_to_1(x: Tensor) -> Tuple[Tensor, ...]:
    """
...
def equivariant_1_to_2(x: Tensor) -> Tuple[Tensor, ...]:
    """
...
def equivariant_2_to_1(x: Tensor) -> Tuple[Tensor, ...]:
    """
...
def equivariant_2_to_2(x: Tensor) -> Tuple[Tensor, ...]:
    """
...
def equivariant_2_to_2_symmetric(x: Tensor) -> Tuple[Tensor, ...]:
    """
